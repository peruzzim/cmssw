...
slimmedElectronsWithUserData = cms.EDProducer("PATElectronUserDataEmbedder",
    ...
    userFloats = cms.PSet(
        ...
        ptRatioVetoPFLeptons = cms.InputTag("ptRatioRelForEle:ptRatioVetoPFLeptons"),
        ptRelVetoPFLeptons = cms.InputTag("ptRatioRelForEle:ptRelVetoPFLeptons"),
        jetNDauChargedMVASelVetoPFLeptons = cms.InputTag("ptRatioRelForEle:jetNDauChargedMVASelVetoPFLeptons"),
