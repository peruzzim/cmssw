...
# with command line options: data94Xv2 -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --filein file:input.root --conditions 102X_dataRun2_v11 -n -1 --era Run2_2017,run2_nanoAOD_94XMiniAODv2 --no_exec --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100
