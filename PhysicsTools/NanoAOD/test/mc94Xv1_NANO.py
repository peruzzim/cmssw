...
# with command line options: mc94Xv1 -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --filein file:input.root --conditions 102X_mc2017_realistic_v6 -n -1 --era Run2_2017,run2_nanoAOD_94XMiniAODv1 --no_exec --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100
