...
# with command line options: mc94Xv2fast -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --filein file:input.root --conditions 102X_mc2017_realistic_v7 -n -1 --era Run2_2017,run2_nanoAOD_94XMiniAODv2 --no_exec --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100 --fast
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('mc94Xv2fast nevts:-1'),
...
process.NANOAODSIMoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('mc94Xv2fast_NANO.root'),
