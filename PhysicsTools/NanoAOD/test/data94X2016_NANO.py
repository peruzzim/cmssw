...
# with command line options: data94X2016 -s NANO --data --eventcontent NANOAOD --datatier NANOAOD --filein file:input.root --conditions 102X_dataRun2_nanoAOD_2016_v1 -n -1 --era Run2_2016,run2_nanoAOD_94X2016 --no_exec --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100
