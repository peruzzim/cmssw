...
# with command line options: mc94X2016 -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --filein file:input.root --conditions 102X_mcRun2_asymptotic_v6 -n -1 --era Run2_2016,run2_nanoAOD_94X2016 --no_exec --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100
