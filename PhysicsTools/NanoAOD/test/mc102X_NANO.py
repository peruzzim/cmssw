...
# with command line options: mc102X -s NANO --mc --eventcontent NANOAODSIM --datatier NANOAODSIM --filein file:input.root --conditions 102X_upgrade2018_realistic_v18 -n -1 --era Run2_2018,run2_nanoAOD_102Xv1 --no_exec --customise_commands=process.add_(cms.Service('InitRootHandlers', EnableIMT = cms.untracked.bool(False)));process.MessageLogger.cerr.FwkReport.reportEvery=100
